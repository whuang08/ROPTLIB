...
%     SolverParams.Finalstepsize = 1;
    SolverParams.Tolerance = 1e-5;
    HasHHR = 1;
    [Xopt, f, gf, gfgf0, iter, nf, ng, nR, nV, nVp, nH, ComTime, funSeries, gradSeries, timeSeries] = TestSphereSparsestVector(Q, Xinitial, HasHHR, 1, SolverParams);
